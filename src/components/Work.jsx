...
const Work = () => {
  return (
    <div name='work' className='w-full md:h-screen text-gray-300 bg-[#002029] pt-10 md:pt-0'>
            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-2 gap-4'>
                ...
                className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
                    ...
                    <div className='opacity-0 group-hover:opacity-100'>
                        ...
                        <p className='text-white text-sm px-4'>A fully responsive portfolio site built implementing Javascript, React, Tailwind, & React-Scroll. It includes project cards, animations, complete responsiveness, and contact form submission. </p>
                        <div className='pt-8 text-center'>
